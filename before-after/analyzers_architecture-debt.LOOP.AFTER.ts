...
export function computeFanInFanOut(graph: DependencyGraph): Map<string, FanMetrics> {
  ...
  _computeFanInFanOutBody(graph, instability, of, result, fanIn, fanOut);
function _computeFanInFanOutBody(graph, instability, of, result, fanIn, fanOut): unknown {
  _computeFanInFanOutBody(graph, _computeFanInFanOutBody, instability, of, result, fanIn, fanOut);
  _computeFanInFanOutBody(graph, _computeFanInFanOutBody, instability, of, result, fanIn, fanOut);
function _computeFanInFanOutBody(graph, _computeFanInFanOutBody, instability, of, result, fanIn, fanOut): unknown {
  _computeFanInFanOutBody(graph, _computeFanInFanOutBody, instability, of, result, fanIn, fanOut);
  _computeFanInFanOutBody(graph, _computeFanInFanOutBody, instability, of, result, fanIn, fanOut);
function _computeFanInFanOutBody(graph, _computeFanInFanOutBody, instability, of, result, fanIn, fanOut): unknown {
  _computeFanInFanOutBody(graph, _computeFanInFanOutBody, instability, of, result, fanIn, fanOut);
...
function _computeFanInFanOutBody(graph, _computeFanInFanOutBody, instability, of, result, fanIn, fanOut): unknown {
  ...
  function _computeFanInFanOutBody(graph, instability, of, result, fanIn, fanOut): unknown {
  _computeFanInFanOutBody(graph, instability, of, result, fanIn, fanOut);
  __computeFanInFanOutBodyBody(graph, instability, of, result, fanIn, fanOut, _computeFanInFanOutBody);
  __computeFanInFanOutBodyBody(graph, instability, of, result, fanIn, fanOut, __computeFanInFanOutBodyBody, _computeFanInFanOutBody);
function __computeFanInFanOutBodyBody(graph, instability, of, result, fanIn, fanOut, __computeFanInFanOutBodyBody, _computeFanInFanOutBody): unknown {
  __computeFanInFanOutBodyBody(graph, instability, of, result, fanIn, fanOut, __computeFanInFanOutBodyBody, _computeFanInFanOutBody);
  __computeFanInFanOutBodyBody(graph, instability, of, result, fanIn, fanOut, __computeFanInFanOutBodyBody, _computeFanInFanOutBody);
function __computeFanInFanOutBodyBody(graph, instability, of, result, fanIn, fanOut, __computeFanInFanOutBodyBody, _computeFanInFanOutBody): unknown {
  __computeFanInFanOutBodyBody(graph, instability, of, result, fanIn, fanOut, __computeFanInFanOutBodyBody, _computeFanInFanOutBody);
function __computeFanInFanOutBodyBody(graph, instability, of, result, fanIn, fanOut, __computeFanInFanOutBodyBody, _computeFanInFanOutBody): unknown {
  function __computeFanInFanOutBodyBody(graph, instability, of, result, fanIn, fanOut, __computeFanInFanOutBodyBody, _computeFanInFanOutBody): unknown {
  function __computeFanInFanOutBodyBody(graph, instability, of, result, fanIn, fanOut, _computeFanInFanOutBody): unknown {
  function _computeFanInFanOutBody(graph, instability, of, result, fanIn, fanOut): unknown {
  _computeFanInFanOutBody(graph, instability, of, result, fanIn, fanOut);
  function _computeFanInFanOutBody(graph, instability, of, result, fanIn, fanOut): unknown {
  // Compute instability
...
export async function analyzeArchitectureDebt(
  ...
  _analyzeArchitectureDebtC1(repoPath, files, { content);
  _analyzeArchitectureDebtC2(repoPath, files, { content, must, be);

  const fileKeys = Object.keys(files);

  // Handle empty input
  _analyzeArchitectureDebtC3(repoPath, files, { content, fileKeys);
  ...
  let maxFanIn = 1;
  let maxChangeFreq = 1;
  _analyzeArchitectureDebtC4(repoPath, files, { content, fanMetrics, maxFanIn);
  _analyzeArchitectureDebtC5(repoPath, files, { content, of, changeFreqMap, values, maxChangeFreq);

  // Step 6: Build ModuleDebtProfile per node
  const modules: ModuleDebtProfile[] = [];

  _analyzeArchitectureDebtC6(repoPath, files, { content, node, of, graph, nodes, fanMetrics, fanIn, propCosts, changeFreqMap, inCycleNodes, maxFanIn, maxChangeFreq, modules);
...
function _analyzeArchitectureDebtC1(repoPath, files, { content): void {
  if (typeof repoPath !== 'string' || repoPath.trim() === '') {
    throw new Error('repoPath must be a non-empty string');
  }
}

function _analyzeArchitectureDebtC2(repoPath, files, { content, must, be): void {
  if (typeof files !== 'object' || files === null) {
    throw new Error('files must be an object');
  }
}

function _analyzeArchitectureDebtC3(repoPath, files, { content, fileKeys): unknown {
...
function _analyzeArchitectureDebtC4(repoPath, files, { content, fanMetrics, maxFanIn): void {
  for (const m of fanMetrics.values()) {
    if (m.fanIn > maxFanIn) maxFanIn = m.fanIn;
  }
}

function _analyzeArchitectureDebtC5(repoPath, files, { content, of, changeFreqMap, values, maxChangeFreq): void {
  for (const v of changeFreqMap.values()) {
    if (v > maxChangeFreq) maxChangeFreq = v;
  }
}

function _analyzeArchitectureDebtC6(repoPath, files, { content, node, of, graph, nodes, fanMetrics, fanIn, propCosts, changeFreqMap, inCycleNodes, maxFanIn, maxChangeFreq, modules): void {
  for (const node of graph.nodes) {
