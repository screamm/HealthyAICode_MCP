...
Generated: 2026-06-02T22:00:00.291Z (real engine run, no fabricated numbers)
Duration: 56392 ms
...
|---|---|---|
| **Detection rate** (recall on divergent) | **100.0%** | 20 / 20 |
...
|---|---|---|---|
| **expected divergent** | 20 (TP) | 0 (FN) | 0 (FN/unv) |
...
| TP | py-06-slice-offbyone | python | off-by-one | divergent | divergent | 5 | behaviour differs on synthesised input #5 |
...
| TP | ts-08-async-await-drop | typescript | async-semantics | divergent | divergent | 1 | Observable behaviour diverged on input #1: before={"user":{"id":1,"name":"user-1"}} after={"user":{}}. The refactoring is NOT behaviour-preserving for this input. |
