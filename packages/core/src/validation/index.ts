...
export { pearsonCorrelation, spearmanCorrelation, computeAUROC, bootstrapAUROC, mannWhitneyU } from './correlation';
...
export { DEFECTS4J_INFO, generateExtractionInstructions, generateBugsJSInstructions } from './defects4j-extractor';
export type { Defects4JInfo } from './defects4j-extractor';
